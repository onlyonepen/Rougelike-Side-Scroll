...
public class RangeEnemyStateManager : EnemyClass
{
    public float WalkSpeed = 2;
    public float ChaseSpeed = 4;
    public float DistaneToAttack = 10;
    [Header("Attack stuff")]
    ...
    public RangeEnemyStateClass CurrentState;

    public RangeEnemyIdleState IdleState = new RangeEnemyIdleState();
    public RangeEnemyPatrolState PatrolState = new RangeEnemyPatrolState();
    public RangeEnemyChaseState ChaseState = new RangeEnemyChaseState();
    public RangeEnemyAttackState AttackState = new RangeEnemyAttackState();
    public RangeEnemyStaggeringState TakeDamageState = new RangeEnemyStaggeringState();
    public RangeEnemyFreezeState FreezeState = new RangeEnemyFreezeState();
    ...
    public void ChangeState(RangeEnemyStateClass state)
    {
    ...
    public GameObject spawnProjectile(GameObject projectile)
    {
